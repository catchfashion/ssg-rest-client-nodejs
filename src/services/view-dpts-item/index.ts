...
export type ViewDptsItemRequestParams = { itemId?: string; splVenItemId?: string };

export type ViewDptsItemResponseParams = {
  result: {
    resultCode: string;
...
export class Client extends BaseClient {
  public async call(params: ViewDptsItemRequestParams): Promise<Response<ViewDptsItemResponseParams>> {
    return await this.client<ViewDptsItemResponseParams>("item/0.3/viewItem.ssg", {
      method: "get",
      searchParams: params,
    });
  }
